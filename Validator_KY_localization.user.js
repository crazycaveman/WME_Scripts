...
window.WME_Validator_United_States = {
  ...
  "128.params": {
    ...
    "template": "${street}",
    "regexp": "!/(Unknown Name| A(cres?|ly|nx|ve|r(c|tery))| B(ay|ch|end|l?vd|lf|ridge|roadway|nd|yp(ass)?|r(a(e|nch|ook))?|ks?|tm|(ike|us)way|yu)| C(t|lb?|hase|mns?|o(rs|rner)|ONN|p|r(es|se|st|k)?|ir|swy|tr|v|u(rv|toff)|yn)| D(am|l|ell|onws|r)| E(ast|dgeway|n(d|t)|xit|sts?|splanade|x(t|py))| F(airway|or(d|ks?)|wy|all|l[st]|t)| G(r|len|rv|r(ee)?n|dns?|a(p|te)|twy)| H(br|ills?|ollows?|ts|wy|ospital)| I(l|nlt)| Junctions?| K(eys?|nls?)| L(ocks?|dg|in[ke]|f|gts?|ndg|[np])|oop| M(all|dw|eadows|nr|anors|t(wy|ns?)?|w|ile|ohr|ews|sn)| N(eck|orth)| O(aks|ne|rch|val|pas)| P(a(rk|ss|th)|ike|r(om|ts?)|de|l(ns|z)?|k(e|s)?|kwys?|ts?)| R([id]|e(ach|st)|ow|i(se|v)|amp|ailroad|nch|R|ailway|pds|idge|u(n(way)?|e)|te)| S(h(ls?|rs?)|kwy|mt|outh|p(ur|ngs|ring)|u(permarket|bdivision)|t(a|n|rut)|[qt]s?)| T(er|hwy|rce|pke?|unnel|urn|r(l|fy)|ra(k|il|in))| U(pas|ns|ppr)| V((ie)?ws?|ista|l(ys?|gs?)|dct|st)| W(alk|ays?|ls?|est|oods|ynde?)| X(-ing|rd)| Yard|^$)( [SNEW]{1,2})?$|^([SNEW]{1,2} )?(Old )?(/d{1,4} [SNEW]|Broadway|MBTA|Railroad|Amtrak|I-|IN-|IA-|KY?-|US-|LA?-|M[DNSO]?-|N[VJYCD]?-|S[CDRH]?-|RI?-|TN-|V[AT]-|W(V|IS)-|C[RH]-|Runway|Place |Parkway|Access |Avenue of |Circle of |State |County |The |to |(Left )?E(xit( to:)?|ntry) )/",
  },
