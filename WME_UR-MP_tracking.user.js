...
function WMEURMPT_Injected() {
  ...
  WMEURMPT.urmpt_version = "3.1.2a1";
  WMEURMPT.URList = [];
  WMEURMPT.URMap = {};
  WMEURMPT.MPList = [];
  WMEURMPT.MPMap = {};
  ...
  WMEURMPT.refreshStats = function(fromDate, toDate) {
    ...
    var closedURbyMe = WMEURMPT.URList.filter(function(value) {
      return value.data.resolvedBy === WMEURMPT.me.id;
    }).length;
    var closedMPbyMe = WMEURMPT.MPList.filter(function(value) {
      return value.data.resolvedBy === WMEURMPT.me.id;
    }).length;
    var niURbyMe = WMEURMPT.URList.filter(function(value) {
    ...
    var niMPbyMe = WMEURMPT.MPList.filter(function(value) {
      return value.data.resolvedBy === WMEURMPT.me.id && value.data.open === false && value.data.resolution == 1;
    }).length;
  ...
  WMEURMPT.saveOptions = function() {
    ...
    filterMPOnlyArea:WMEURMPT.currentMPOnlyArea, filterURCommentsCount:WMEURMPT.currentURCommentsCount};
