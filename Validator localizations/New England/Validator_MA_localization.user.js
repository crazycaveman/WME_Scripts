...
window.WME_Validator_United_States = {
  ...
  "130.params": {
    ...
    "problemEN": "All state highways should be named SR-### in Massachusetts",
    "solutionEN": "Change name to SR-### (if it is truly a state highway)",
    "template": "${state}:#${street}#${altStreet[#]}",
    "regexp": "/^Massachusetts:.*\\b(?:State Hwy|State R(ou)?te|MA-|SH-)\\b/i"
  },
  "130.solutionLink": "W:Massachusetts#Naming",
  "131.enabled": true,
  "131.params": {
