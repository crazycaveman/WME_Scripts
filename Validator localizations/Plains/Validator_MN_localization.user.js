...
window.WME_Validator_United_States = {
  ...
  "130.params": {
    ...
    "problemEN": "All state highways should be named MN-### in Minnesota",
    "solutionEN": "Change name to MN-### (if it is truly a state highway)",
    "template": "${state}:#${street}#${altStreet[#]}",
    "regexp": "/^Minnesota:.*\\b(State Hwy |S[HhRr][- =])[0-9]{1,3}/"
  },
